const coreUserDirectoryActionComponentMap: Record<string, string[]> = {
  ['@quidproquo-core/UserDirectory/AuthenticateUser']: [
    'askUserDirectoryAuthenticateUser',
    'userDirectoryName',
    'authenticateUserRequest',
  ],
  ['@quidproquo-core/UserDirectory/ForgotPassword']: [
  ...
  ['@quidproquo-core/UserDirectory/CreateUser']: [
    'askUserDirectoryCreateUser',
    'userDirectoryName',
    'createUserRequest',
  ],
  ['@quidproquo-core/UserDirectory/RequestEmailVerification']: [
    'askUserDirectoryRequestEmailVerification',
    'userDirectoryName',
    'accessToken',
  ],
  ['@quidproquo-core/UserDirectory/ConfirmEmailVerification']: [
    'askUserDirectoryConfirmEmailVerification',
    'code',
    'accessToken',
  ],
  ['@quidproquo-core/UserDirectory/ReadAccessToken']: [
    'askUserDirectoryReadAccessToken',
    'userDirectoryName',
    'ignoreExpiration',
    'serviceOverride',
  ],
  ['@quidproquo-core/UserDirectory/SetAccessToken']: [
  ...
  ['@quidproquo-core/UserDirectory/RespondToAuthChallenge']: [
    'askUserDirectoryRespondToAuthChallenge',
    'userDirectoryName',
    'authChallenge',
  ],
  ['@quidproquo-core/UserDirectory/GetUserAttributes']: [
  ...
  ['@quidproquo-core/UserDirectory/ChangePassword']: [
    'askUserDirectoryChangePassword',
    'oldPassword',
    'newPassword',
  ],
  ['@quidproquo-core/UserDirectory/SetPassword']: [
    'askUserDirectorySetPassword',
    'userDirectoryName',
    'username',
    'newPassword',
  ],
  ['@quidproquo-core/UserDirectory/GetUsers']: [
