const coreFileActionComponentMap: Record<string, string[]> = {
  ...
  ['@quidproquo-core/File/WriteTextContents']: [
  ...
  ['@quidproquo-core/File/ListDirectory']: [
  ...
  ['@quidproquo-core/File/WriteBinaryContents']: [
  ...
  ['@quidproquo-core/File/GenerateTemporarySecureUrl']: [
