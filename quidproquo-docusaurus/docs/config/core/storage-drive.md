...
- **CORS for browser access:** `defineStorageDriveCorsSettings` (quidproquo-webserver) controls the allowed browser origins for direct-to-drive uploads/downloads.
