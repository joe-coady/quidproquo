import { EventDocEventPayload, EventDocPublishData, EventDocSummary } from '../../models';
...
export const publishSummary = (model: EventDocSummary, { data, metadata }: EventDocEventPayload<EventDocPublishData>): EventDocSummary => ({
  ...model,
