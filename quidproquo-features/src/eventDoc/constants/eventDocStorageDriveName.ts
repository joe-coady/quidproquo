// Per-collection blob bucket, named off the store (+ an EventDoc marker) so it can't
...
export const eventDocStorageDriveName = (storeName: string): string => `${storeName}EventDocStorage`.toLowerCase();
