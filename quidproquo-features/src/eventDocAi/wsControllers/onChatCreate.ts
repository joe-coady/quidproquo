...
const askChatCreateRequest = createServiceRequester<
  EventDocAiChatCreatePayload,
  EventDocAiChatSummary
>('eventDocAi', 'ChatCreate');

export const onChatCreate = eventDocAiServiceRequest(
  askChatCreateRequest,
  function* askOnChatCreate(payload) {
