import { askFileReadTextContents, askKeyValueStoreQuery, askKeyValueStoreUpsert, AskResponse, kvsAnd, kvsBetween, kvsEqual, QpqPagedData, QpqRuntimeType, StoryResult } from 'quidproquo-core';
